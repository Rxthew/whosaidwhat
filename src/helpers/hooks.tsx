...
export const useFetchIndexData = function () {
  ...
  useEffect(() => {
    ...
    const setFreshUser = function (
      res: Record<"user" | "posts", UserInterface | PostsType>
    ) {
    ...
    const setFreshIndexData = function (
      res: Record<"user" | "posts", UserInterface | PostsType>
    ) {
      setFreshUser(res);
      setFreshPosts(res);
