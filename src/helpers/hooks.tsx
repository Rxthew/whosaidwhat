...
export const useFetchIndexData = function(){
    ...
    useEffect(()=> {
        ...
        const fetchData = async function(){
            const response = await fetch("https://wswapi.onrender.com/", { //Update url when ready.
            ...
            return response.ok ?  setFreshIndexData(await response.json().catch((err:Error)=> {throw err})) : false
        };
